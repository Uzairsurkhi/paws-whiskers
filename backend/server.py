...
PRODUCTS = [
    ...
    },
    {
        ...
        "variants": [
            {"label": "480 g", "in_stock": True, "price": 299},
            {"label": "1.2 kg", "in_stock": True, "price": 549},
            {"label": "3 kg", "in_stock": True, "price": 1199},
            {"label": "20kg", "in_stock": True, "price": 4950},
            {"label": "20 kg", "in_stock": True, "price": 4950},
        ],
        "pros": [
    ...
    },
    {
        ...
        "label": "Budget Pick",
        "best_for": "Value-conscious multi-cat homes",
        "price_range": "₹ 299 - ₹ 4,950",
        "pack_sizes": "480 g / 1.2 kg / 3 kg / 20 kg",
        "rating": 4.5,
        "key_benefit": "Widely available, cats love the taste",
        "image": IMG["kibble_blue"],
        "variants": [
